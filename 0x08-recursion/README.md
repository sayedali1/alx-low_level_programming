...
| [3](/0x08-recursion/3-factorial.c) | Write a function that returns the factorial of a given number. <ul><li> If `n` is lower than `0`, the function should return `-1` to indicate an error<ul><li>Factorial of `0` is `1` |
